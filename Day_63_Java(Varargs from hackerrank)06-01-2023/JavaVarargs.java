//Program: You are given a class Solution and its main method in the editor.
...
class Add{
    ...
    public void add(int ...n){ //... for taking n number of args
        ...
        sb=sb.deleteCharAt(sb.length()-1); //to delete extra "+"
