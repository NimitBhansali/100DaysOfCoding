//Program- According to Wikipedia, a factory is simply an object that returns another object from some other method call, which is assumed to be "new".
...
interface Food {
	...
	class FoodFactory {
		public Food getFood(String order) {
            //line added to the code in hacker rank is--
     return  order.equalsIgnoreCase("pizza") ? new Pizza() : new Cake();
            //to check if string entered by user is pizza or cake we do above line of code
